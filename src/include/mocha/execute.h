...
const struct mocha_object* script_execute_1(const struct mocha_context* context, const struct mocha_function* script_fn, const struct mocha_object* argument);
